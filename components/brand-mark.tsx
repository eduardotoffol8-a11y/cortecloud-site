export function BrandMark({ compact = false }: { compact?: boolean }) {
  return (
    <div className="flex items-center gap-3">
      <div className="relative grid h-10 w-10 shrink-0 place-items-center overflow-hidden rounded-xl bg-[#103f3a] text-white shadow-sm">
        <svg viewBox="0 0 40 40" aria-hidden="true" className="h-10 w-10">
          ...
          <path d="M15 11.5v4m5-4v2.5m5-2.5v4M11 23h18" fill="none" stroke="#60d4c8" strokeWidth="1.8" />
        </svg>
      </div>
      {!compact && (
        <div>

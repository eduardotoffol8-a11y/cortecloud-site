...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/orcamovel-install-192-v2.png?v=20260916-6", sizes: "192x192", type: "image/png" },
      { url: "/orcamovel-install-512-v2.png?v=20260916-6", sizes: "512x512", type: "image/png" },
    ],
    apple: [{ url: "/orcamovel-install-192-v2.png?v=20260916-6", sizes: "192x192", type: "image/png" }],
  },
};
